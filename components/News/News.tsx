...
//                     (post?.continueTitle || "")
//                   }
//                   mainCategory={post?.categories?.[0]?.title ?? ""}
//                 />
//               ))}
//         </div>
//         <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:w-full">
//           {data.length > 0 &&
//             data
//               .slice(0, 2)
//               .map((post, idx) => (
...
//         <div className="w-full h-40 bg-tertiary">
//           <p className="text-5xl"> publicidad </p>
//         </div>
//       </div>
//       <div className="flex flex-col gap-10 w-full mb-10">
