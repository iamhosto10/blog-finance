  ...
  return (
    <footer className="bg-primary-background text-background px-10 md:px-20 py-10 self-end">
      <div className=" mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-3">
        ...
        {/* Texto y botón */}
        <div className="text-center md:text-left max-w-xl self-center">
          <h2 className="text-3xl lg:text-5xl font-bold font-agrandir">
            EL MONOPOLOMBIANO
          </h2>
      ...
      <div className="flex flex-col items-center mt-10 gap-4 ">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-4">
          <p className="font-agrandir font-bold text-sm lg:text-lg">
